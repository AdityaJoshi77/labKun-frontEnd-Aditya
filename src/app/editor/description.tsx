...
const Description = () => {
  return (
    <main className='flex flex-col h-screen w-[500px] resize-x overflow-hidden rounded-md bg-gray-800 border border-black'>

        {/* Description.TitleBar */}
        <div className='flex text-white font-semibold bg-gray-700 rounded-md m-1 pt-4 pb-4'>
            {/* icon div */}
        ...
        <div className=' text-white font-semibold bg-gray-700 rounded-md m-1 pt-4 pb-4 '>
            <p className='text-center'>Footer bar kuch iss tarah ka dikhega</p>
        </div>
    </main>
  )
}
